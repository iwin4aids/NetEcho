 ...
 */
public class JSONServerDecoder extends MessageToMessageDecoder<ByteBuf> {
    ...
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf msg, List<Object> list) throws Exception {
        ...
        list.add(JSON.parseObject(new String(data, StandardCharsets.UTF_8)).toJavaObject(RpcRequest.class));
    }
}