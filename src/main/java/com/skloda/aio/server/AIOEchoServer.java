...
class AIOServerThread implements Runnable { // 是进行AIO处理的线程类
    ...
    public AIOServerThread() throws Exception {
        ...
        this.serverChannel.bind(new InetSocketAddress(ServerInfo.SERVER_PORT)) ; // 绑定服务端口
        System.out.println("服务器启动成功，在" + ServerInfo.SERVER_PORT + "端口上监听服务 ...");
    }
